<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16 items-center">
            <div class="flex">
                ...
                @if(auth()->check())
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('post.index') }}" :active="request()->routeIs('post')">
                            {{ __('Post') }}
                        </x-jet-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
            ...
            <ul class="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
                    <a href="{{ route('login') }}" class="block py-2 pr-4 pl-3 rounded md:p-0 bg-red"  aria-current="page"><i class="fa-solid fa-user"></i> Login</a>
                </li>
            </ul>
        </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('movie.home') }}" :active="request()->routeIs('home')">
                {{ __('Dashboard') }}
