    ...
    <x-jet-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div>
                ...
                <p id="name" class="mt-2 text-sm text-red-500 dark:text-red-400">
                    @error('name')
                        {{ $message }}
                    @enderror
                </p>
            ...
            <div>
                ...
                <p id="username" class="mt-2 text-sm text-red-500 dark:text-red-400">
                    @error('username')
                        {{ $message }}
                    @enderror
                </p>
            ...
            <div class="mt-4">
                ...
                <p id="email" class="mt-2 text-sm text-red-500 dark:text-red-400">
                    @error('email')
                        {{ $message }}
                    @enderror
                </p>
            ...
            <div class="mt-4">
                ...
                <p id="password" class="mt-2 text-sm text-red-500 dark:text-red-400">
                    @error('password')
                        {{ $message }}
                    @enderror
                </p>
            ...
            <div class="mt-4">
                ...
                <p id="password_confirmation" class="mt-2 text-sm text-red-500 dark:text-red-400">
